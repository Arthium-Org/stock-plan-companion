...
- [ ] **Phase 1: Download Wiring & Release Config** - A registered visitor downloads the correct, signed macOS build from the right repo; Windows shows a safe placeholder; future releases need only a config edit
