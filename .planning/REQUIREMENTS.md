...
- [ ] **REG-02**: Each submission is recorded to a Google Sheet via a Google Apps Script endpoint (no monthly submission cap)
- [ ] **REG-03**: On successful submission, the download options are revealed (existing behavior preserved)
- [ ] **REG-04**: A failed submission shows an inline error without discarding the entered email (existing behavior preserved)
