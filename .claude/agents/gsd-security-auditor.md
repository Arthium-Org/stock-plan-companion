...
**Verification depth scales with `asvs_level`** (see @/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
