...
<required_reading>
Read `/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
