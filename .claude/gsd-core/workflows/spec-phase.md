...
ones). Reference: @/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/kirandev/Projects/stock-plan-companion/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/kirandev/Projects/stock-plan-companion/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/templates/spec.md.
