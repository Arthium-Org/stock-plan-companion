...
```
Agent(
  prompt="Read /Users/kirandev/Projects/stock-plan-companion/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/templates/VALIDATION.md`
