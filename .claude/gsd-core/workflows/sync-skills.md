...
INSTALL_JS_GLOBAL="/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
