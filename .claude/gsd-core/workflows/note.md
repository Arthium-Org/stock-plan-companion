...
- **Global scope**: `/Users/kirandev/Projects/stock-plan-companion/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/kirandev/Projects/stock-plan-companion/.claude/notes/`)
...
2. Glob `/Users/kirandev/Projects/stock-plan-companion/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/kirandev/Projects/stock-plan-companion/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/kirandev/Projects/stock-plan-companion/.claude/notes/` — works in any directory
