...
<!-- For checkpoint task examples and patterns, see @/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
