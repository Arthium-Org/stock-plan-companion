...
- Usage: Reference from command with `@/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/kirandev/Projects/stock-plan-companion/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/kirandev/Projects/stock-plan-companion/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
