...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/kirandev/Projects/stock-plan-companion/.claude/.gsd-surface.json`
(sibling to `/Users/kirandev/Projects/stock-plan-companion/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/kirandev/Projects/stock-plan-companion/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/kirandev/Projects/stock-plan-companion/.claude/skills`).
...
`/Users/kirandev/Projects/stock-plan-companion/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/kirandev/Projects/stock-plan-companion/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/kirandev/Projects/stock-plan-companion/.claude/.gsd-surface.json`
Install profile marker: `/Users/kirandev/Projects/stock-plan-companion/.claude/.gsd-profile`
Skill dirs: `/Users/kirandev/Projects/stock-plan-companion/.claude/skills/gsd-*/`
Engine module: `/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/kirandev/Projects/stock-plan-companion/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
